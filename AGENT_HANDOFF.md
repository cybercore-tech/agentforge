...
- Active milestone: P1-M002 — Single-task orchestration loop.
- Active plan: `.plans/P1-M002-orchestration-loop.plan.md` — Approved.
- Active plan: none.
- Active plan: none.
...
- P1-M002 plan: `.plans/P1-M002-orchestration-loop.plan.md` — Approved; implementation may begin within the declared boundary.
...
7. Implement P1-M002 only within the approved plan boundary and record exact CI evidence.
