...
- Active milestone: none; P0-M009 closure CI is pending before merge.
- Active plan: none.
...
7. Verify CI for the P0-M009 closure commit, then merge and verify the resulting main commit.
