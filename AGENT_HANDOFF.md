...
- P1-M003 plan: `.plans/P1-M003-project-intake.plan.md` — Draft; approval is required before activation.
...
7. Approve P1-M003 separately before implementation; keep blueprint intake changes within its declared boundary.
