...
- Active milestone: P2-M002 — Interactive operator HUD.
- Active plan: `.plans/P2-M002-interactive-hud.plan.md` — Approved.
...
- P2-M002 plan: `.plans/P2-M002-interactive-hud.plan.md` — Approved; implementation may begin after checkpoint CI.
...
7. Implement P2-M002 only within the approved plan boundary after its activation checkpoint CI is green.
