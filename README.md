...
> **Status:** `0.2.0-alpha` · latest release
> ([v0.2.0](https://github.com/cybercore-tech/agentforge/releases/tag/v0.2.0)) · alpha: evolving
...
- the next release, `v0.3.0`, the first with attested archives (P5).
