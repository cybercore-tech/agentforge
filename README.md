...
- **P3-M006** external MCP servers behind the gateway: declared, capability-mapped, and audited,
  with unmapped tools invisible;
- **P5-M007** release
...
- remote (HTTP) MCP servers behind the gateway (P3), and the real two-machine run (P4).
