...
| P1-M006 | active | Concurrent batch launch | Disjoint ready tasks launch concurrently from one command with a single state coordinator; overlapping and over-limit tasks are deferred deterministically. |
