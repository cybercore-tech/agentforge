...
| P1-M004 | active | Orchestrated gate evidence | Configured project gates run automatically after a successful agent in every run/launch path, record durable `GateFinished` evidence, and fail the task when any gate fails. |
