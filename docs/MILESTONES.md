...
| P1-M003 | active | Project blueprint and task intake | Operators can author validated project guidance and explicit task contracts through durable files and CLI commands. |
