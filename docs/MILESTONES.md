...
| P2-M030 | active | Milestone tags | Every completed milestone has an annotated `milestone/<ID>` tag on its closure commit, tagging is part of closure, and release tags stay separate. |
